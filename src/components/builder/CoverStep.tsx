  ...
  return (
    <div className="space-y-8">
                ...
                <div className="flex flex-col items-end" style={{ paddingTop: "2.5%" }}>
                  ...
                  <p
                    ...
                    style={{
                      ...
                      fontSize: "clamp(10px, 3.18vw, 10px)",
                      letterSpacing: 0,
                    }}
                  >
                    {subtitle}
                  ...
                  <p
                    ...
                    style={{
                      ...
                      fontSize: "clamp(12px, 3.75vw, 12px)",
                      marginTop: "2.5%",
      ...
      <div className="flex justify-between pt-4">
        ...
        >
          {canContinue
            ? (hasMoreBooks ? "Continue to Next Book" : (sharedBookCount && sharedBookCount > 1 ? "See Your Finished Books" : "Continue to Checkout"))
