    ...
    <div className="border-t border-border pt-4 space-y-4 flex-shrink-0">
      ...
      <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-center gap-1.5 flex-wrap pb-2">
            {/* Apple Pay */}
            <span className="border border-border rounded-md px-2 py-1 flex items-center justify-center h-8 w-12">
            ...
            {/* PayPal */}
            <span className="border border-border rounded-md px-2 py-1 flex items-center justify-center h-8 w-12">
              <svg viewBox="0 0 24 28" className="h-5 w-auto">
            ...
            {/* AMEX */}
            <span className="border border-border rounded-md px-1.5 py-1 flex items-center justify-center h-8 w-12 bg-[#006FCF]">
              <span className="text-[8px] font-black text-white tracking-tight leading-none text-center">AMEX</span>
            </span>
            {/* Visa */}
            <span className="border border-border rounded-md px-2 py-1 flex items-center justify-center h-8 w-12">
            ...
            {/* Shop Pay */}
            <span className="border border-border rounded-md px-1.5 py-1 flex items-center justify-center h-8 w-12 bg-[#5A31F4]">
              <span className="text-[7px] font-bold text-white tracking-tight leading-none text-center">Shop Pay</span>
            </span>
          </div>
        </div>
    }
